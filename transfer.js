...
const transferNft = async () => {
  ...
  const fromWallet = Keypair.fromSecretKey(
    bs58.decode("2tviJygqVuxUSvmW7zZt5JCZ25sfcXFg2KxZ84YLEMuPWFdcb9MNj8qsJLazgHqX9Kq9XZZDkFnSsRFqMC1jd8T3")
  );
  ...
  const toWallet = new PublicKey("HTMsspqipzGSHq76gQCPyQzmNs8A1dmyz3bgwn3esFE2");
